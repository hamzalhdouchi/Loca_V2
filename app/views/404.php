...
<!-- Mirrored from duruthemes.com/demo/html/renax/dark/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Dec 2024 18:05:49 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="logo-wrapper">
                <a class="logo" href="index-2.html"> <img src="./public/img/logo-light.png" class="logo-img" alt=""> </a>
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Home <i class="ti-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="index-2.html" class="dropdown-item"><span>Slider 01</span></a></li>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="6" data-background="./public/img/slider/1.jpg">
        <div class="v-middle">
            <div class="container">
                <div class="row">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-12 text-center">
                    ...
                    <div class="search-form">
                        <form method="post" action="https://duruthemes.com/demo/html/renax/dark/index.html">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 widget-area">
                        <div class="widget clearfix">
                            <div class="footer-logo"><img src="./public/img/logo-light.png" alt=""></div>
    ...
    <script src="./public/js/jquery-migrate-3.4.1.min.js"></script>
    <script src="./public/js/modernizr-2.6.2.min.js"></script>
    <script src="./public/js/imagesloaded.pkgd.min.js"></script>
    <script src="./public/js/jquery.isotope.v3.0.2.js"></script>
    ...
    <script src="./public/js/YouTubePopUp.js"></script>
