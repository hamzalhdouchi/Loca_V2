...
<!-- Mirrored from duruthemes.com/demo/html/renax/dark/cars4.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Dec 2024 18:05:31 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <!-- Header Banner -->
    <section class="banner-header section-padding bg-img" data-overlay-dark="5" data-background="img/slider/11.jpg">
        <div class="v-middle">
            <div class="container">
                ...
                <div class="col-lg-8 col-md-12 car-list">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 mb-30">
                            <div class="item">
                                <figure><img src="./app/views/assets/img/img_6773f38f38d828.36831609.png" alt="" class="img-fluid"></figure>
                                <div class="content">
                                    <div class="cont">
