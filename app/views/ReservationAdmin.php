...
$reservation = $reserv->getReservation();
    
    if ($_SERVER["REQUEST_METHOD"] == 'POST' && isset($_POST['status'])) {
        $id = $_POST['id'];
        $status = $_POST['stat'];
        
        $reserv->Setstatus($status,$id);
    }
?>
        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="./reservationAdmin.php" class="active">
            ...
            <table width="100%">
                <thead>
                    <tr>
                        ...
                        <th><span class="las la-sort"></span>Date Reservation</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <h4><?= htmlspecialchars($row['date_reservation']) ?></h4>
                            </td>
                            <td>
                                <h4><?= htmlspecialchars($row['adresse']) ?></h4>
                            </td>
                            ...
                            <?php
                                    if ($row['status'] == 2) { ?>
                                        <span class="reserved-badge bg-gradient-to-r from-red-400 to-red-500 text-white px-4 py-1.5 rounded-full font-semibold shadow-md inline-block">
                                                <form action="" method="POST" class="m-0 p-0">
                                                    <input type="hidden" name="id" value="<?= htmlspecialchars($row['id_reservation']) ?>">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                            ...
                                            <span class="reserved-badge bg-gradient-to-r from-gray-400 to-gray-500 text-white px-4 py-1.5 rounded-full font-semibold shadow-md inline-block">
                                                <form action="" method="POST" class="m-0 p-0">
                                                    <input type="hidden" name="id" value="<?= htmlspecialchars($row['id_reservation']) ?>">
